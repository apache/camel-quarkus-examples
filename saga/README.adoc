...
image::doc-resources/logic-diagram.png[Logical diagram showing saga pattern flow between app, flight service, train service, and payment service]

==== Compensating a failure

image::doc-resources/compensate-diagram.png[Diagram illustrating compensation flow when payment fails in the saga pattern]

==== Technical view

image::doc-resources/tech-diagram.png[Technical architecture diagram showing HTTP communication with LRA coordinator and AMQ messaging between services]
