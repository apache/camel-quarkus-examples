...
public class SpringRedisProducers {
    ...
    JedisConnectionFactory produceJedisConnectionFactory() {
    ...
    private synchronized void init() {
        ...
        connectionFactory = new JedisConnectionFactory(conf);
        redisConfiguration.setConnectionFactory(connectionFactory);
        connectionFactory.start();

        redisTemplate = (RedisTemplate<String, String>) redisConfiguration.getRedisTemplate();
    }
}
