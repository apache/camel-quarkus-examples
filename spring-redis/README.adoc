...
IMPORTANT: The Redis extension does not support native mode due to limitations with Spring Data Redis and GraalVM native compilation. Please use JVM mode for this example.
